...
func ListIssueRequests(c *gin.Context) {
	...
	if err := config.DB.Raw(`
		...
		WHERE b.lib_id = ? AND r.approval_date IS NULL
	`, libID).Scan(&requests).Error; err != nil {
...
// ListLibraries returns all libraries along with the number of books in each library.
func ListLibraries(c *gin.Context) {
	...
	// Build the response including the number of books for each library.
	var result []gin.H
